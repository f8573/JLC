...
The comparison is the post-cleanup control recorded in the CPU compiler/runtime
research record. It preserves the selected build flags, affinity policy, panel
schedule, and provider configuration; it does not claim that JLC is
vendor-competitive for every size or thread count.
